...
plot_mse_output <- function(mods,
  ...
  if (output_format == "png") {
    ...
    plot_calls <- list(
      ...
      function() plot_fbar_performance(mods, is.nsim, main_dir, output_dir, "Fbar", width, height, dpi, col.opt, f.ymin, f.ymax, new_model_names, use.n.years.last),
      function() plot_fbar_performance(mods, is.nsim, main_dir, output_dir, "Fbar", width, height, dpi, col.opt, f.ymin, f.ymax, new_model_names, use.n.years.last, base.model),
      ...
      function() plot_fbar_performance2(mods, is.nsim, main_dir, output_dir, "Fbar", width, height, dpi, col.opt, f.ymin, f.ymax, new_model_names, use.n.years.first, start.years),
      function() plot_fbar_performance2(mods, is.nsim, main_dir, output_dir, "Fbar", width, height, dpi, col.opt, f.ymin, f.ymax, new_model_names, use.n.years.first, start.years, base.model),
      ...
      function() plot_fbar_status(mods, is.nsim, main_dir, output_dir, "Fbar_status", width, height, dpi, col.opt, f.ymin, f.ymax, new_model_names, use.n.years.last),
      function() plot_fbar_status(mods, is.nsim, main_dir, output_dir, "Fbar_status", width, height, dpi, col.opt, f.ymin, f.ymax, new_model_names, use.n.years.last, base.model),
      function() plot_fbar_status2(mods, is.nsim, main_dir, output_dir, "Fbar_status", width, height, dpi, col.opt, f.ymin, f.ymax, new_model_names, use.n.years.first, start.years),
      function() plot_fbar_status2(mods, is.nsim, main_dir, output_dir, "Fbar_status", width, height, dpi, col.opt, f.ymin, f.ymax, new_model_names, use.n.years.first, start.years, base.model),
    ...
    rmd_lines <- c(
      ...
      "plot_fbar_performance(mods, is.nsim, '.', output_dir, 'Fbar', width, height, dpi, col.opt, f.ymin, f.ymax, new_model_names, use.n.years.last)",
      "plot_fbar_performance(mods, is.nsim, '.', output_dir, 'Fbar', width, height, dpi, col.opt, f.ymin, f.ymax, new_model_names, use.n.years.last, base.model)",
      ...
      "plot_fbar_performance2(mods, is.nsim, '.', output_dir, 'Fbar', width, height, dpi, col.opt, f.ymin, f.ymax, new_model_names, use.n.years.first, start.years)",
      "plot_fbar_performance2(mods, is.nsim, '.', output_dir, 'Fbar', width, height, dpi, col.opt, f.ymin, f.ymax, new_model_names, use.n.years.first, start.years, base.model)",
      ...
      "plot_fbar_status(mods, is.nsim, '.', output_dir, 'Fbar_status', width, height, dpi, col.opt, f.ymin, f.ymax, new_model_names, use.n.years.last, base.model = NULL)",
      "plot_fbar_status(mods, is.nsim, '.', output_dir, 'Fbar_status', width, height, dpi, col.opt, f.ymin, f.ymax, new_model_names, use.n.years.last, base.model, plot_prob = FALSE)",
      "plot_fbar_status2(mods, is.nsim, '.', output_dir, 'Fbar_status', width, height, dpi, col.opt, f.ymin, f.ymax, new_model_names, use.n.years.first, start.years, base.model = NULL)",
      "plot_fbar_status2(mods, is.nsim, '.', output_dir, 'Fbar_status', width, height, dpi, col.opt, f.ymin, f.ymax, new_model_names, use.n.years.first, start.years, base.model, plot_prob = FALSE)",
