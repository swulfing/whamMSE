...
<head>
  ...
  <style>
    ...
    .navbar img.icon {
      ...
      margin-right: 8px; /* Adjust this value for spacing between icon and text */
    }
    .container {
      max-width: 800px;
      margin: auto;
...
<body>
  <div class="navbar">
    <a href="index.html">
      <img src="icons/home-icon.png" class="icon" alt="Home Icon"> Home
    </a>
    <div class="dropdown">
      <button class="dropbtn">
        <img src="icons/vignettes-icon.png" class="icon" alt="Vignettes Icon"> Vignettes
      </button>
